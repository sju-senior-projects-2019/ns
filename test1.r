...
X = c(0.2066666666666667, 0.2, 0.2, 0.21000000000000002)
Y = c(-0.7806666666666665, -0.7844, -0.7924, -0.7827999999999999)
TX = c(0.2, 0.22, 0.2)
TY = c(-0.7924, -0.7732, -0.7764)
show( X, Y, TX, TY, title="Quad 2, Triangle 1")

X = c(0.2066666666666667, 0.2, 0.2, 0.21000000000000002)
Y = c(-0.7806666666666665, -0.7844, -0.7764, -0.7747999999999999)
TX = c(0.2, 0.22, 0.2)
TY = c(-0.7924, -0.7732, -0.7764)
show( X, Y, TX, TY, title="Quad 3, Triangle 1")

X = c(0.25146666666666667, 0.21000000000000002, 0.2, 0.2672)
Y = c(-0.7790666666666666, -0.7827999999999999, -0.7924, -0.782)
TX = c(0.22, 0.2, 0.3344)
TY = c(-0.7732, -0.7924, -0.7716)
show( X, Y, TX, TY, title="Quad 4, Triangle 2")

X = c(0.25146666666666667, 0.2772, 0.22, 0.21000000000000002)
Y = c(-0.7790666666666666, -0.7724, -0.7732, -0.7827999999999999)
TX = c(0.22, 0.2, 0.3344)
TY = c(-0.7732, -0.7924, -0.7716)
show( X, Y, TX, TY, title="Quad 5, Triangle 2")

X = c(0.25146666666666667, 0.2772, 0.3344, 0.2672)
Y = c(-0.7790666666666666, -0.7724, -0.7716, -0.782)
TX = c(0.22, 0.2, 0.3344)
TY = c(-0.7732, -0.7924, -0.7716)
...
X = c(0.3589333333333333, 0.3528, 0.3712, 0.3712)
Y = c(-0.7801333333333332, -0.782, -0.7924, -0.7844)
TX = c(0.3712, 0.3712, 0.3344)
TY = c(-0.7924, -0.7764, -0.7716)
show( X, Y, TX, TY, title="Quad 8, Triangle 3")

X = c(0.3589333333333333, 0.3528, 0.3344, 0.3528)
...
X = c(0.2909333333333333, 0.2772, 0.3344, 0.3264)
Y = c(-0.7686666666666667, -0.7724, -0.7716, -0.7664)
TX = c(0.3344, 0.3184, 0.22)
TY = c(-0.7716, -0.7612, -0.7732)
show( X, Y, TX, TY, title="Quad 11, Triangle 4")

X = c(0.2909333333333333, 0.2772, 0.22, 0.2692)
Y = c(-0.7686666666666667, -0.7724, -0.7732, -0.7672)
TX = c(0.3344, 0.3184, 0.22)
TY = c(-0.7716, -0.7612, -0.7732)
...
X = c(0.30186666666666667, 0.28559999999999997, 0.3712, 0.3528)
Y = c(-0.7854666666666666, -0.7924, -0.7924, -0.782)
TX = c(0.3712, 0.3344, 0.2)
TY = c(-0.7924, -0.7716, -0.7924)
show( X, Y, TX, TY, title="Quad 14, Triangle 5")

X = c(0.30186666666666667, 0.28559999999999997, 0.2, 0.2672)
Y = c(-0.7854666666666666, -0.7924, -0.7924, -0.782)
TX = c(0.3712, 0.3344, 0.2)
TY = c(-0.7924, -0.7716, -0.7924)
...
X = c(0.26133333333333336, 0.2328, 0.22, 0.2692)
Y = c(-0.7636, -0.7647999999999999, -0.7732, -0.7672)
TX = c(0.22, 0.3184, 0.2456)
TY = c(-0.7732, -0.7612, -0.7564)
show( X, Y, TX, TY, title="Quad 17, Triangle 6")

X = c(0.26133333333333336, 0.2328, 0.2456, 0.28200000000000003)
Y = c(-0.7636, -0.7647999999999999, -0.7564, -0.7587999999999999)
TX = c(0.22, 0.3184, 0.2456)
TY = c(-0.7732, -0.7612, -0.7564)
show( X, Y, TX, TY, title="Quad 18, Triangle 6")

X = c(0.2784, 0.2788, 0.312, 0.2948)
Y = c(-0.7326666666666667, -0.748, -0.7396, -0.7208)
TX = c(0.2456, 0.312, 0.2776)
TY = c(-0.7564, -0.7396, -0.702)
show( X, Y, TX, TY, title="Quad 19, Triangle 7")

X = c(0.2784, 0.2616, 0.2456, 0.2788)
Y = c(-0.7326666666666667, -0.7292, -0.7564, -0.748)
TX = c(0.2456, 0.312, 0.2776)
TY = c(-0.7564, -0.7396, -0.702)
show( X, Y, TX, TY, title="Quad 20, Triangle 7")

X = c(0.2784, 0.2616, 0.2776, 0.2948)
Y = c(-0.7326666666666667, -0.7292, -0.702, -0.7208)
TX = c(0.2456, 0.312, 0.2776)
TY = c(-0.7564, -0.7396, -0.702)
show( X, Y, TX, TY, title="Quad 21, Triangle 7")

X = c(0.292, 0.2788, 0.2456, 0.28200000000000003)
Y = c(-0.7524000000000001, -0.748, -0.7564, -0.7587999999999999)
...
X = c(0.292, 0.31520000000000004, 0.3184, 0.28200000000000003)
Y = c(-0.7524000000000001, -0.7504, -0.7612, -0.7587999999999999)
TX = c(0.312, 0.2456, 0.3184)
TY = c(-0.7396, -0.7564, -0.7612)
show( X, Y, TX, TY, title="Quad 24, Triangle 8")

X = c(0.30293333333333333, 0.2948, 0.312, 0.3156)
Y = c(-0.7161333333333334, -0.7208, -0.7396, -0.7232000000000001)
TX = c(0.2776, 0.312, 0.3192)
TY = c(-0.702, -0.7396, -0.7068)
show( X, Y, TX, TY, title="Quad 25, Triangle 9")

X = c(0.30293333333333333, 0.2984, 0.2776, 0.2948)
Y = c(-0.7161333333333334, -0.7043999999999999, -0.702, -0.7208)
TX = c(0.2776, 0.312, 0.3192)
TY = c(-0.702, -0.7396, -0.7068)
show( X, Y, TX, TY, title="Quad 26, Triangle 9")

X = c(0.30293333333333333, 0.2984, 0.3192, 0.3156)
Y = c(-0.7161333333333334, -0.7043999999999999, -0.7068, -0.7232000000000001)
TX = c(0.2776, 0.312, 0.3192)
TY = c(-0.702, -0.7396, -0.7068)
show( X, Y, TX, TY, title="Quad 27, Triangle 9")

X = c(0.3802666666666667, 0.3832, 0.2776, 0.326)
Y = c(-0.4932, -0.4548, -0.702, -0.6359999999999999)
...
X = c(0.3802666666666667, 0.4316, 0.3744, 0.326)
Y = c(-0.4932, -0.3888, -0.57, -0.6359999999999999)
TX = c(0.4888, 0.2776, 0.3744)
TY = c(-0.2076, -0.702, -0.57)
show( X, Y, TX, TY, title="Quad 30, Triangle 10")

X = c(0.33760000000000007, 0.36760000000000004, 0.3744, 0.326)
Y = c(-0.6254666666666666, -0.5871999999999999, -0.57, -0.6359999999999999)
TX = c(0.3608, 0.3744, 0.2776)
TY = c(-0.6044, -0.57, -0.702)
show( X, Y, TX, TY, title="Quad 31, Triangle 11")

X = c(0.33760000000000007, 0.31920000000000004, 0.3608, 0.36760000000000004)
Y = c(-0.6254666666666666, -0.6532, -0.6044, -0.5871999999999999)
TX = c(0.3608, 0.3744, 0.2776)
TY = c(-0.6044, -0.57, -0.702)
show( X, Y, TX, TY, title="Quad 32, Triangle 11")

X = c(0.33760000000000007, 0.31920000000000004, 0.2776, 0.326)
Y = c(-0.6254666666666666, -0.6532, -0.702, -0.6359999999999999)
TX = c(0.3608, 0.3744, 0.2776)
TY = c(-0.6044, -0.57, -0.702)
show( X, Y, TX, TY, title="Quad 33, Triangle 11")

X = c(0.4408, 0.36760000000000004, 0.3608, 0.47400000000000003)
Y = c(-0.5929333333333333, -0.5871999999999999, -0.6044, -0.6044)
TX = c(0.3744, 0.3608, 0.5872)
TY = c(-0.57, -0.6044, -0.6044)
show( X, Y, TX, TY, title="Quad 34, Triangle 12")

X = c(0.4408, 0.4808, 0.3744, 0.36760000000000004)
Y = c(-0.5929333333333333, -0.5871999999999999, -0.57, -0.5871999999999999)
TX = c(0.3744, 0.3608, 0.5872)
TY = c(-0.57, -0.6044, -0.6044)
show( X, Y, TX, TY, title="Quad 35, Triangle 12")

X = c(0.4408, 0.4808, 0.5872, 0.47400000000000003)
Y = c(-0.5929333333333333, -0.5871999999999999, -0.6044, -0.6044)
TX = c(0.3744, 0.3608, 0.5872)
TY = c(-0.57, -0.6044, -0.6044)
show( X, Y, TX, TY, title="Quad 36, Triangle 12")

X = c(0.3192, 0.31920000000000004, 0.2776, 0.2984)
Y = c(-0.6710666666666666, -0.6532, -0.702, -0.7043999999999999)
...
X = c(0.3192, 0.33999999999999997, 0.3192, 0.2984)
Y = c(-0.6710666666666666, -0.6556, -0.7068, -0.7043999999999999)
TX = c(0.3608, 0.2776, 0.3192)
TY = c(-0.6044, -0.702, -0.7068)
show( X, Y, TX, TY, title="Quad 39, Triangle 13")

X = c(0.4456, 0.4316, 0.3744, 0.42400000000000004)
Y = c(-0.36946666666666667, -0.3888, -0.57, -0.45039999999999997)
TX = c(0.4888, 0.3744, 0.4736)
TY = c(-0.2076, -0.57, -0.3308)
show( X, Y, TX, TY, title="Quad 40, Triangle 14")

X = c(0.4456, 0.4812, 0.4888, 0.4316)
Y = c(-0.36946666666666667, -0.2692, -0.2076, -0.3888)
TX = c(0.4888, 0.3744, 0.4736)
TY = c(-0.2076, -0.57, -0.3308)
show( X, Y, TX, TY, title="Quad 41, Triangle 14")

X = c(0.4456, 0.4812, 0.4736, 0.42400000000000004)
Y = c(-0.36946666666666667, -0.2692, -0.3308, -0.45039999999999997)
TX = c(0.4888, 0.3744, 0.4736)
TY = c(-0.2076, -0.57, -0.3308)
...
X = c(0.5933333333333334, 0.5792, 0.5792, 0.6004)
Y = c(-0.7801333333333332, -0.7844, -0.7924, -0.782)
TX = c(0.5792, 0.6216, 0.5792)
TY = c(-0.7924, -0.7716, -0.7764)
...
X = c(0.6669333333333333, 0.6004, 0.5792, 0.6896)
Y = c(-0.7854666666666666, -0.782, -0.7924, -0.7924)
TX = c(0.6216, 0.5792, 0.8)
TY = c(-0.7716, -0.7924, -0.7924)
show( X, Y, TX, TY, title="Quad 46, Triangle 16")

X = c(0.6669333333333333, 0.7108000000000001, 0.6216, 0.6004)
Y = c(-0.7854666666666666, -0.782, -0.7716, -0.782)
TX = c(0.6216, 0.5792, 0.8)
TY = c(-0.7716, -0.7924, -0.7924)
show( X, Y, TX, TY, title="Quad 47, Triangle 16")

X = c(0.6669333333333333, 0.7108000000000001, 0.8, 0.6896)
Y = c(-0.7854666666666666, -0.782, -0.7924, -0.7924)
TX = c(0.6216, 0.5792, 0.8)
TY = c(-0.7716, -0.7924, -0.7924)
...
X = c(0.7914666666666667, 0.7872, 0.8, 0.8)
Y = c(-0.7803999999999999, -0.7824, -0.7924, -0.7844)
TX = c(0.8, 0.8, 0.7744)
TY = c(-0.7924, -0.7764, -0.7724)
show( X, Y, TX, TY, title="Quad 50, Triangle 17")

X = c(0.7914666666666667, 0.7872, 0.7744, 0.7872)
Y = c(-0.7803999999999999, -0.7824, -0.7724, -0.7744)
TX = c(0.8, 0.8, 0.7744)
TY = c(-0.7924, -0.7764, -0.7724)
show( X, Y, TX, TY, title="Quad 51, Triangle 17")

X = c(0.7173333333333334, 0.6888000000000001, 0.6216, 0.698)
Y = c(-0.7684000000000001, -0.7664, -0.7716, -0.772)
...
X = c(0.7173333333333334, 0.7652, 0.7744, 0.698)
Y = c(-0.7684000000000001, -0.7667999999999999, -0.7724, -0.772)
TX = c(0.756, 0.6216, 0.7744)
TY = c(-0.7612, -0.7716, -0.7724)
show( X, Y, TX, TY, title="Quad 54, Triangle 18")

X = c(0.6704, 0.6948000000000001, 0.6336, 0.6276)
Y = c(-0.7652, -0.762, -0.7628, -0.7672)
...
X = c(0.6704, 0.6888000000000001, 0.6216, 0.6276)
Y = c(-0.7652, -0.7664, -0.7716, -0.7672)
TX = c(0.756, 0.6336, 0.6216)
TY = c(-0.7612, -0.7628, -0.7716)
show( X, Y, TX, TY, title="Quad 57, Triangle 19")

X = c(0.7319999999999999, 0.698, 0.6216, 0.7108000000000001)
Y = c(-0.7788, -0.772, -0.7716, -0.782)
...
X = c(0.7319999999999999, 0.7872, 0.8, 0.7108000000000001)
Y = c(-0.7788, -0.7824, -0.7924, -0.782)
TX = c(0.7744, 0.6216, 0.8)
TY = c(-0.7724, -0.7716, -0.7924)
show( X, Y, TX, TY, title="Quad 60, Triangle 20")

X = c(0.6066666666666668, 0.5396000000000001, 0.5744, 0.6576)
Y = c(-0.5057333333333333, -0.3888, -0.57, -0.6548)
...
X = c(0.6066666666666668, 0.6228, 0.7408, 0.6576)
Y = c(-0.5057333333333333, -0.4736, -0.7396, -0.6548)
TX = c(0.5048, 0.5744, 0.7408)
TY = c(-0.2076, -0.57, -0.7396)
show( X, Y, TX, TY, title="Quad 63, Triangle 21")

X = c(0.512, 0.4808, 0.5872, 0.5808)
Y = c(-0.5814666666666666, -0.5871999999999999, -0.6044, -0.5871999999999999)
TX = c(0.3744, 0.5872, 0.5744)
TY = c(-0.57, -0.6044, -0.57)
show( X, Y, TX, TY, title="Quad 64, Triangle 22")

X = c(0.512, 0.47440000000000004, 0.3744, 0.4808)
Y = c(-0.5814666666666666, -0.57, -0.57, -0.5871999999999999)
TX = c(0.3744, 0.5872, 0.5744)
TY = c(-0.57, -0.6044, -0.57)
show( X, Y, TX, TY, title="Quad 65, Triangle 22")

X = c(0.512, 0.47440000000000004, 0.5744, 0.5808)
Y = c(-0.5814666666666666, -0.57, -0.57, -0.5871999999999999)
TX = c(0.3744, 0.5872, 0.5744)
TY = c(-0.57, -0.6044, -0.57)
show( X, Y, TX, TY, title="Quad 66, Triangle 22")

X = c(0.4890666666666667, 0.4812, 0.4736, 0.4892)
Y = c(-0.24866666666666667, -0.2692, -0.3308, -0.2692)
TX = c(0.4888, 0.4736, 0.5048)
TY = c(-0.2076, -0.3308, -0.2076)
show( X, Y, TX, TY, title="Quad 67, Triangle 23")

X = c(0.4890666666666667, 0.4968, 0.4888, 0.4812)
Y = c(-0.24866666666666667, -0.2076, -0.2076, -0.2692)
TX = c(0.4888, 0.4736, 0.5048)
TY = c(-0.2076, -0.3308, -0.2076)
show( X, Y, TX, TY, title="Quad 68, Triangle 23")

X = c(0.4890666666666667, 0.4968, 0.5048, 0.4892)
Y = c(-0.24866666666666667, -0.2076, -0.2076, -0.2692)
TX = c(0.4888, 0.4736, 0.5048)
TY = c(-0.2076, -0.3308, -0.2076)
show( X, Y, TX, TY, title="Quad 69, Triangle 23")

X = c(0.6341333333333333, 0.5808, 0.5872, 0.664)
Y = c(-0.638, -0.5871999999999999, -0.6044, -0.672)
...
X = c(0.6341333333333333, 0.6576, 0.7408, 0.664)
Y = c(-0.638, -0.6548, -0.7396, -0.672)
TX = c(0.5744, 0.5872, 0.7408)
TY = c(-0.57, -0.6044, -0.7396)
show( X, Y, TX, TY, title="Quad 72, Triangle 24")

X = c(0.5176, 0.524, 0.5744, 0.5396000000000001)
Y = c(-0.36946666666666667, -0.45039999999999997, -0.57, -0.3888)
TX = c(0.4736, 0.5744, 0.5048)
TY = c(-0.3308, -0.57, -0.2076)
show( X, Y, TX, TY, title="Quad 73, Triangle 25")

X = c(0.5176, 0.4892, 0.4736, 0.524)
Y = c(-0.36946666666666667, -0.2692, -0.3308, -0.45039999999999997)
TX = c(0.4736, 0.5744, 0.5048)
TY = c(-0.3308, -0.57, -0.2076)
show( X, Y, TX, TY, title="Quad 74, Triangle 25")

X = c(0.5176, 0.4892, 0.5048, 0.5396000000000001)
Y = c(-0.36946666666666667, -0.2692, -0.2076, -0.3888)
TX = c(0.4736, 0.5744, 0.5048)
TY = c(-0.3308, -0.57, -0.2076)
...
X = c(0.6712000000000001, 0.6364000000000001, 0.6336, 0.6872)
Y = c(-0.7489333333333335, -0.7536, -0.7628, -0.7512000000000001)
TX = c(0.6336, 0.7408, 0.6392)
TY = c(-0.7628, -0.7396, -0.7444)
show( X, Y, TX, TY, title="Quad 77, Triangle 26")

X = c(0.6712000000000001, 0.6364000000000001, 0.6392, 0.69)
Y = c(-0.7489333333333335, -0.7536, -0.7444, -0.742)
TX = c(0.6336, 0.7408, 0.6392)
TY = c(-0.7628, -0.7396, -0.7444)
show( X, Y, TX, TY, title="Quad 78, Triangle 26")

X = c(0.7101333333333333, 0.6872, 0.6336, 0.6948000000000001)
Y = c(-0.7545333333333334, -0.7512000000000001, -0.7628, -0.762)
...
X = c(0.7101333333333333, 0.7484, 0.756, 0.6948000000000001)
Y = c(-0.7545333333333334, -0.7504, -0.7612, -0.762)
TX = c(0.7408, 0.6336, 0.756)
TY = c(-0.7396, -0.7628, -0.7612)
show( X, Y, TX, TY, title="Quad 81, Triangle 27")

X = c(0.6496000000000001, 0.6808000000000001, 0.7408, 0.664)
Y = c(-0.6761333333333334, -0.712, -0.7396, -0.672)
TX = c(0.6208, 0.7408, 0.5872)
TY = c(-0.6844, -0.7396, -0.6044)
show( X, Y, TX, TY, title="Quad 82, Triangle 28")

X = c(0.6496000000000001, 0.6040000000000001, 0.6208, 0.6808000000000001)
Y = c(-0.6761333333333334, -0.6444000000000001, -0.6844, -0.712)
TX = c(0.6208, 0.7408, 0.5872)
TY = c(-0.6844, -0.7396, -0.6044)
show( X, Y, TX, TY, title="Quad 83, Triangle 28")

X = c(0.6496000000000001, 0.6040000000000001, 0.5872, 0.664)
Y = c(-0.6761333333333334, -0.6444000000000001, -0.6044, -0.672)
TX = c(0.6208, 0.7408, 0.5872)
TY = c(-0.6844, -0.7396, -0.6044)
show( X, Y, TX, TY, title="Quad 84, Triangle 28")

X = c(0.6669333333333333, 0.6808000000000001, 0.6208, 0.63)
Y = c(-0.7228, -0.712, -0.6844, -0.7143999999999999)
TX = c(0.7408, 0.6208, 0.6392)
TY = c(-0.7396, -0.6844, -0.7444)
show( X, Y, TX, TY, title="Quad 85, Triangle 29")

X = c(0.6669333333333333, 0.69, 0.7408, 0.6808000000000001)
Y = c(-0.7228, -0.742, -0.7396, -0.712)
TX = c(0.7408, 0.6208, 0.6392)
TY = c(-0.7396, -0.6844, -0.7444)
show( X, Y, TX, TY, title="Quad 86, Triangle 29")

X = c(0.6669333333333333, 0.69, 0.6392, 0.63)
Y = c(-0.7228, -0.742, -0.7444, -0.7143999999999999)
TX = c(0.7408, 0.6208, 0.6392)
TY = c(-0.7396, -0.6844, -0.7444)
